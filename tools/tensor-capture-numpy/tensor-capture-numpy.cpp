 ...
 * analysis easier - we can capture multiple runs from different models and compare them using a
 * simple Python script, for example. Once a tensor is saved to disk as a `.npy` file, then it
 * can be directly as a NumPy array in any Python script.
 *
